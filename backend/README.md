...
## Project Structure
    ...
    ├── wandering_river_28790  # Django project configurations
...
1. Clone this repo and `cd wandering_river_28790`
...
2. Clone this repo and `cd wandering_river_28790`
